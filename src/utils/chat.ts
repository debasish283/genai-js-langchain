...
export const chat = async (rl: readlinePromises.Interface, handler: ChatHandler) => {
  console.log("(Type 'exit', 'quit', or 'menu' to return to main menu)\n");
  ...
  while (true) {
    ...
    if (
      ...
      question.toLowerCase().trim() === "menu"
    ) {
      break;
    }
